...
\item
  ...
  settings(\citeproc{ref-wikiwerewolf}{Wikipedia contributors 2024}). In
...
\item
  ...
  \item
    ...
    (\citeproc{ref-laiWerewolfUsMultimodal2022}{Lai et al. 2022}), a
    collection of real human gameplay annotated with persuasion
    strategies,
  \item
    \emph{Werewolf Arena}
    (\citeproc{ref-bailisWerewolfArenaCase2024}{Bailis, Friedhoff, and
    Chen 2024}), a simulated environment where LLM agents play the game
    autonomously.
  \item
...
2024}) features simulated classic Werewolf games played by LLM agents

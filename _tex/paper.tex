...
(GUI), depicted in Figure Figure~\ref{fig-wwa-gui}. The GUI displays the
game state, including player roles, actions, and current discussion
rounds, enabling monitoring of the gameplay progression.

\textbf{Figure 1.} GUI of Werewolf Arena simulation environment.

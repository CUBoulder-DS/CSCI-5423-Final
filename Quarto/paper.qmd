...
Agents participated in gameplay through a graphical user interface (GUI), depicted in Figure @fig:wwa-gui. The GUI displays the game state, including player roles, actions, and current discussion rounds, enabling monitoring of the gameplay progression.

![GUI of Werewolf Arena simulation](Images/WWA_GUI.PNG.png){#fig-wwa-gui}
